...
description: Headless morning pre-check (scheduled Routine): verifies task completion signals across Gmail/Slack/Calendar/Transcripts, auto-marks HIGH-confidence completions, and writes Inbox/Morning Precheck.md for /morning to consume.
---
